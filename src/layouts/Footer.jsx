    ...
    <div className="container">
      <div className="row justify-content-evenly">
        ...
        <div className="col-lg-3 col-md-6 mb-4">
          ...
          <ul className="contact_us">
            <li><Link to="#">Premium App Development Studio</Link></li>
            <li><Link to="#">Mobile App Development Dubai</Link></li>
            <li><Link to="#">Mobile App Development New York</Link></li>
            <li><Link to="#">Enterprise Software Development</Link></li>
            <li><Link to="#">Blockchain Development</Link></li>
            <li><Link to="#">Fintech Development</Link></li>
            <li><Link to="#">On Demand Development</Link></li>
            <li><Link to="#">UI/UX Design - Allurive</Link></li>
            <li><Link to="#">Web Development</Link></li>
            <li><Link to="#">Growth & Marketing</Link></li>
          </ul>
        </div>
        <div className="col-lg-3 col-md-6 mb-4">
          ...
          <ul className="contact_us">
            ...
            <li><Link to="#">Freelancer</Link></li>
            <li><Link to="#">E-Commerce</Link></li>
            <li><Link to="#">Peer-to-Peer</Link></li>
        ...
        <div className="col-lg-3 col-md-6 mb-4">
          <div className="card shadow p-2">
            ...
            <input type="number" placeholder="Enter Number" className="pr-1 py-2" />
      ...
      <div className="row">
        <div className="col-12 text-center my-5">
          <p>© 2024 Karan Sankhyan | All Rights Reserved | Privacy Policy | Return Policy | Terms & conditions ramadan_popup</p>
        </div>
      </div>
    </div>
  );
